...
def main():
    parser = argparse.ArgumentParser(description="将 Mermaid Markdown 知识图谱转换为课程 JSON。")
    parser.add_argument("input", type=Path, help="包含 flowchart 的 Markdown 文件。")
    parser.add_argument("output", type=Path, help="目标 knowledge_graph.json 文件。")
