      ...
      <div className="welcome-page">
        <div className="welcome-topbar">
          ...
          <div className="welcome-topbar-actions">
            <a href={routeHref(routes.course)} className="welcome-topbar-link">
              我的课程
            </a>
          ...
          <div className="welcome-content">
            <Space direction="vertical" size="large" align="center" style={{ width: "100%" }}>
              ...
              <div className="welcome-hero-actions">
                <a href={routeHref(routes.course)} className="welcome-hero-link welcome-hero-link-primary">
                  查看全部课程
                </a>
                <a href={routeHref(routes.profile)} className="welcome-hero-link">
                  进入个人中心
                </a>
              </div>
            </Space>
