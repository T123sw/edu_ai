...
assert.match(chatPanelFile, /artifact_type:\s*normalizeArtifactReferenceType\(/, 'ChatPanel should preserve report artifact references when restoring conversations');
