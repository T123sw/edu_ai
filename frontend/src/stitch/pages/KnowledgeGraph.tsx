              ...
              {activeNode ? (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="rounded-[18px] bg-(--surface-subtle) p-4 text-xs leading-6 text-(--muted-text)">
                      资料统一在“课程资料”视图上传和维护；知识结构只负责课程概念及其关系。
                    </p>
                    <a
                      href={buildTeacherCourseHash("knowledge", courseId, { view: "documents" })}
                      className="mt-3 inline-flex items-center gap-2 rounded-full border border-(--accent-border) bg-(--accent-soft) px-4 py-2 text-xs font-bold text-(--accent-strong)"
                    >
                      <MaterialIcon name="article" className="text-base" />
                      查看课程资料
                    </a>
