...
const material = { material_id: "one", material_type: "quiz", course_id: "course", version: 3, owner_user_id: "teacher", visibility: "private" as const, title: "数组练习" };
...
test("stable ID and server version are required; ownership is checked", () => {
  ...
  assert.deepEqual(createRevisionIntent(material, "teacher")?.reference, { artifact_id: "one", artifact_type: "quiz", version_id: "v3", title: "数组练习", source_course_id: "course" });
});
