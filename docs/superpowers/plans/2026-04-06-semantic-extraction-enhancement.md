...
Run: `d:\github\edu_ai\backend\src\.venv\Scripts\python.exe -m pytest tests\chat\test_llm_enhancement_provider.py -v`
...
Run: `d:\github\edu_ai\backend\src\.venv\Scripts\python.exe -m pytest tests\chat\test_extraction_guard.py -v`
...
Run: `d:\github\edu_ai\backend\src\.venv\Scripts\python.exe -m pytest tests\chat\test_llm_enhancement_provider.py tests\chat\test_extraction_guard.py -v`
...
**Files:**
- Modify: `backend/src/tests/chat/test_llm_enhancement_router.py`
...
Run: `d:\github\edu_ai\backend\src\.venv\Scripts\python.exe -m pytest tests\chat\test_llm_enhancement_router.py tests\chat\test_route_chat_service.py -v`
