...
**Files:**
- Modify: `backend/src/tests/chat/test_llm_enhancement_provider.py`
- Modify: `backend/src/tests/chat/test_extraction_guard.py`
- Modify: `backend/src/tests/chat/test_route_feature_flags.py`
...
Run: `d:\github\edu_ai\backend\src\.venv\Scripts\python.exe -m pytest tests\chat\test_llm_enhancement_provider.py tests\chat\test_extraction_guard.py tests\chat\test_route_feature_flags.py -v`
...
**Files:**
- Modify: `backend/src/app/chat/orchestrator/llm_enhancement_provider.py`
- Modify: `backend/src/app/chat/orchestrator/extraction_guard.py`
- Modify: `backend/src/app/chat/application/route_feature_flags.py`
...
**Files:**
- Test: `backend/src/tests/chat/test_llm_enhancement_router.py`
- Test: `backend/src/tests/chat/test_route_service_factory.py`

- [ ] **Step 1: Run integration tests**

Run: `d:\github\edu_ai\backend\src\.venv\Scripts\python.exe -m pytest tests\chat\test_llm_enhancement_router.py tests\chat\test_route_service_factory.py -v`
