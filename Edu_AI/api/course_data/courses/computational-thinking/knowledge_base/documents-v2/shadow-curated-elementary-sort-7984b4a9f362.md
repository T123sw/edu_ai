# Sorting Networks 开放课程活动｜精选补充资料

> 来源：[CS Unplugged](https://classic.csunplugged.org/activities/sorting-networks/)  
> 许可：[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)  
> 语言：英文  
> 获取时间：2026-08-08T09:44:56.480486+00:00
...
## Activity description (PDF) [#](#activity-description-pdf)
...
### Translations and other versions [#](#translations-and-other-versions)
...
See our [video page](https://classic.csunplugged.org/videos/#sorting-networks).
...
[![Photos from Computer Science camps for students aged 8-12, run by Mark Laprairie of the University of Regina.](shadow-curated-elementary-sort-7984b4a9f362.assets/36ac63e8d3daef1d.jpg)](/images/activities/sorting-networks/sorting-networks-photo-1_1.jpg)
[![Students in New Zealand run the sorting network outdoors.](shadow-curated-elementary-sort-7984b4a9f362.assets/87a548d92dd39873.jpg)](/images/activities/sorting-networks/sorting-networks-photo-2_0.jpg)
[![Sorting networks can also be set up as a board game if there's not enough space to run around.](shadow-curated-elementary-sort-7984b4a9f362.assets/68e3fc9fd63d11ab.jpg)](/images/activities/sorting-networks/sorting-networks-photo-3_0.jpg)
[![Tim guides students in Sorting Networks activity, UOC, Christchurch, 17-18.04.2008](shadow-curated-elementary-sort-7984b4a9f362.assets/bf1ffd9885678595.jpg)](/images/activities/sorting-networks/DSC24754.jpg)
[![Prof Wada with students, Informatics Education Symposium 2010, Osaka, Japan](shadow-curated-elementary-sort-7984b4a9f362.assets/e572e869442889fe.jpg)](/images/activities/sorting-networks/IMG_0680.jpg)
...
### More lessons and activities [#](#more-lessons-and-activities)
...
### If you want to find out more [#](#if-you-want-to-find-out-more)
...
## Sorting network records [#](#sorting-network-records)
...
In 2005, a [demonstration video for sorting networks](https://www.youtube.com/watch?v=30WcPnvfiKE) shows 21 students making and using a sorting network (near the end of the video)

In September 2019, [50 pupils from high schools in Vienna, performed a sorting network](https://www.youtube.com/watch?v=eI0nniqgQnc), which is based on the data available on the CS Unplugged classic, one of the largest ones ever performed

## Curriculum Links [#](#curriculum-links)

### Great Principles of Computer Science [#](#great-principles-of-computer-science)
